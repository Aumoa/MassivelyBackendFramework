...
{
    ValueTask<string> CreateApiKeyAsync(string accountId, string clientId, string name, CancellationToken cancellationToken = default);
    ValueTask<ApiKeyInfo[]> GetApiKeysAsync(string accountId, string clientId, CancellationToken cancellationToken = default);
