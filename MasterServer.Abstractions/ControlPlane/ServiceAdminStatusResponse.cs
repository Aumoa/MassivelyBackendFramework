...
public sealed class ServiceAdminStatusResponse
{
        ...
        DateTimeOffset observedAt)
    {
        ...
        if (nodeKind is not (MasterNodeKind.Gateway or MasterNodeKind.Dedicated or MasterNodeKind.MasterAdmin or MasterNodeKind.Backend or MasterNodeKind.Unknown))
        {
