    ...
    bool wrong_request_id)
{
    return std::async(
        ...
        [listener, wrong_request_id] {
            ...
            require(
                request_frame.header.packet_id == sidecar_pid_direct_connect_validation_request,
            ...
            auto response_frame = make_frame(
                packet_kind::control,
...
void sidecar_validator_sends_validation_request()
{
    ...
    require(response.gateway_master_connection_id == "gateway-master-a", "Response gateway Master connection mismatch.");
    ...
    require(
        observed.gateway_master_connection_id == "gateway-master-a",
