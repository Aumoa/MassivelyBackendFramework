...
namespace JenkinsFailureAnalyzer.Authentication;

internal sealed class JenkinsFailureAnalyzerAuthenticationHandler(
...
{
    public const string SchemeName = "JenkinsFailureAnalyzerOidc";
    private const string LoginRedirectPath = "/auth/redirect";
    private const string LoginScope = "openid groups";
